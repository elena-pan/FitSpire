...
class LogExercise extends Component {
    constructor() {
        super();
        const initDate = new Date(new Date().setSeconds(0, 0));
        this.state = {
            user: {},
            exercise: "",
            start: initDate,
    ...
    componentDidMount = () => {
        ...
        M.Datepicker.init(elem1, {
            ...
            minDate: new Date(new Date().setFullYear(new Date().getFullYear() - 1)), // Min date is a year from now
    ...
    onSubmit = e => {
        ...
        this.props.addExercise(exerciseData, this.props.history);
    }
            ...
            <div className="wrapper">
                ...
                <div className="col s8 offset-s2">
                    ...
                    <div className="col s6">
                        ...
                        defaultValue={new Date().getHours() + ":" + ("0" + new Date().getMinutes()).slice(-2)}
                        ></input>
                    </div>
                    ...
                    <div className="col s6">
                        <input type="text" defaultValue={new Date().getHours() + ":" + ("0" + new Date().getMinutes()).slice(-2)}
