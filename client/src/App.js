...
import LogExercise from "./components/dashboard/exercises/LogExercise";
import EditExercise from "./components/dashboard/exercises/EditExercise";
import UserChallenges from "./components/dashboard/challenges/UserChallenges";
      ...
      <Router>
        <div className="App">
          ...
          <Switch>
            ...
            <PrivateRoute exact path="/log-exercise" component={LogExercise} />
            <PrivateRoute exact path="/exercises/edit/:id" component={EditExercise} />
            <PrivateRoute exact path="/challenges" component={UserChallenges} />
